      ...
      <div className="bg-gradient-to-br from-[#060d1f] to-[#0d1f3c] text-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-5">
            ...
            {post.author && <span className="text-xs font-bold text-blue-300 bg-blue-500/10 px-3 py-1.5 rounded-full">{post.author}</span>}
          </div>
          ...
          <article className="lg:col-span-2">
            ...
            <div className="mt-6 bg-white rounded-2xl border border-gray-100 p-5 shadow-sm">
              ...
              <div className="flex gap-2">
                <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent(shareUrl)}`} target="_blank" rel="noopener noreferrer" className="bg-sky-500 hover:opacity-90 text-white font-bold text-xs px-4 py-2.5 rounded-xl flex items-center gap-2"><Twitter className="w-3.5 h-3.5" /> Twitter</a>
