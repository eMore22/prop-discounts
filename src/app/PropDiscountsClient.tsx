// src/app/PropDiscountsClient.tsx
// This handles all the interactive parts (filtering, sorting, copying)
...
// All your existing components (CountdownTimer, StatusBadge, Toast, DiscountCard)
// Copy them exactly as they are - I'll just include the main component here
...
const DiscountCard: React.FC<{ discount: DiscountCode; onCopy: (code: string) => void }> = ({ discount, onCopy }) => {
  ...
  return (
    <div className={`bg-white rounded-xl shadow-md p-6 border-2 transition-all hover:shadow-xl ${isExpired ? 'border-red-200 opacity-60' : 'border-blue-200 hover:border-blue-400'}`}>
      {/* Keep all your existing DiscountCard JSX exactly as is */}
...
// Main component receives data from server
export default function PropDiscountsClient({ 
  initialDiscountCodes 
}: { 
  initialDiscountCodes: DiscountCode[] 
}) {
  const [discountCodes] = useState<DiscountCode[]>(initialDiscountCodes);
  ...
  // Keep all your existing JSX for the UI
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">Prop Firm Discounts</h1>
            <p className="text-lg text-gray-600">Exclusive promo codes for top prop trading firms</p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Keep your existing table and card grid JSX */}
