// src/app/prop-firms/[firm]/FirmDetailClient.tsx
// Handles all interactive parts of the firm detail page
...
interface Props {
  firm: FirmDetail;
  otherFirms: FirmDetail[];
}

export default function FirmDetailClient({ firm, otherFirms }: Props) {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Offer",
            "name": `${firm.firm} Discount Code`,
            "description": `Save ${firm.discount} on ${firm.firm}`,
            "url": `https://www.propcoupouns.com/prop-firms/${firm.slug}`,
            "priceSpecification": {
            ...
            "validThrough": firm.expiry || "2025-12-31",
            "seller": {
              "@type": "Organization",
              "name": "Prop Discounts"
            }
